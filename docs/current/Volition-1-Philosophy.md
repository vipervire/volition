...
- **Autonomy through Advice, Not Shims:** Agents are given "full freedom." We _explicitly reject_ the "hard shim" concept. A Abe _must_ first call an "advisor" script (e.g., `spawn-advisor.sh`) to get data, but the Abe makes the final decision.
