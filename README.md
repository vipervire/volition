...
* Is Persistent: They wake up where they left off, with memory of past actions, and context of what they were doing. Once a Abe is spawned, they are supposed to
run forever.
...
* If a Abe makes a mistake, the result notifies him back immediately in the next 'turn,' and thus allowing the Abe to correct it.
